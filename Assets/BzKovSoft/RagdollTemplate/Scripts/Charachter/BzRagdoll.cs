...
namespace BzKovSoft.RagdollTemplate.Scripts.Charachter
{
    ...
    public sealed class BzRagdoll : MonoBehaviour, IBzRagdoll
    {
        ...
        // animator animations:
        [SerializeField] string _animationGetUpFromBelly = "GetUp.GetUpFromBelly";
        [SerializeField] string _animationGetUpFromBack = "GetUp.GetUpFromBack";
        ...
        float
            _ragdollingEndTime; //A helper variable to store the time when we transitioned from ragdolled to blendToAnim state

        const float
            RagdollToMecanimBlendTime = 0.5f; //How long do we blend when transitioning from ragdolled to animated
        ...
        public void ActivateRagdollParts(bool activate)
        {
